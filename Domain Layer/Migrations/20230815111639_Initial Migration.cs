        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalAttachments = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ReverteeCertificate = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    TravellingAttachment = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    OverSeaHospitalDocument = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
